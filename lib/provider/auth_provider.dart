...
class AuthProvider with ChangeNotifier {
  ...
  */
  ...
  Future saveUser(SingleUserModel user, String uid) async {
  ...
  USER LOGIN
  */
  Future signInEmailPass(SingleUserModel user) async {
    _status = Status.Authenticating;
    notifyListeners();
    try {
  ...
  USER PASSWORD RESET
  */
  Future resetPass(SingleUserModel user) async {
    var response;
    try {
  ...
  */
  ...
  Future<FirebaseUser> signInWithGoogle() async {
    try {
      ...
      SingleUserModel model = new SingleUserModel(
